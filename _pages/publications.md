...
How do organized interests value institutional power in American legislatures? I examine how campaign contributors respond to different forms of procedural authority in U.S. state legislatures, focusing on the relationship between campaign contributions and institutional leadership. I begin by unpacking a widely used measure of influence --- "committee assignment power" --- and show that its apparent relationship with campaign contributions is highly composition-sensitive and driven by a small number of states and legislators. Comparing models across institutional contexts, I demonstrate that the explanatory weight of assignment power shifts toward leadership offices such as the Speaker and Senate President, suggesting that donors are not rewarding assignment authority in isolation. Linking these findings to Anzia and Jackman's (2013) coding of procedural powers, I show that campaign contributions are most strongly associated with agenda-setting and gatekeeping authority. Contributions flow primarily to a bundled package of procedural powers that structure the legislative process rather than to any single institutional lever.
...
I examine whether legislators seek committee assignments whose jurisdictions align with their seed donors' interests. I define committee jurisdiction in two ways: first, by examining donations to committee members in the previous election cycle, and second, by identifying the committees to which bills on specific policy issues were referred. To test whether legislators join committees aligned with their seed donors' interests, I analyze match rates between members' seed donor interests and committee affiliations over their careers. I also estimate a survival model, treating placement on a seed interest-related committee as the event, and compare the time it takes for members to join a seed donor interest committee versus a bandwagon interest committee. I find that most legislators secure a position on a seed donor-related committee by their fourth cycle, with Republicans doing so earlier and at higher rates than Democrats.
...
### Money and Supreme Court Nominations
